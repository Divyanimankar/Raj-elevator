      ...
      <section className="contactHero">
        <div className="contactHeroContent">
          ...
          <p className="contactHeroSubtitle">
            Connect with India's premier high-precision elevator
            manufacturing team. Request systematic technical specs,
            site shaft audits, or AMC proposals.
          </p>
        </div>
      </section>
      ...
      <div className="contactGrid">
        ...
        <div className="contactCard">
          ...
          <div className="contactCardText">
            205, Hari Om Plaza, M.G. Road, Borivali (East),
            Mumbai - 400 066
          </div>
        </div>
        ...
        <div className="offices-grid">
          ...
          <div className="office-card">
            ...
            <div className="office-card__row">
              ...
              <span>
                #20/27, Kaveri Complex, Gokula Stage 1,
                Phase 1, 1st Main Road, Mathikere,
                Bangalore - 560 054.
              </span>
